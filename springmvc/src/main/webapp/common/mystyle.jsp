...
<!-- 张瑞引入的js  -->
<script type="text/javascript" src="<%=request.getContextPath()%>/js/validator/bootstrapValidator.min.js"></script>
<link href="<%=request.getContextPath()%>/js/validator/bootstrapValidator.min.css" rel="stylesheet" />
