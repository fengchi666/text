		...
		<form id = "myForm" class = "form-inline">
			<table>
					<tr>
						...
						<td>
							<input type="text" name = "goodName" class="form-control" id="goodName1">
						</td>
					</tr>
					<tr>
						<td height="50px">
						...
						<td>
							<input type="text" name = "inventory" class="form-control date" id="inventory1">
						</td>
					</tr>
					<tr>
						<td height="50px">
						...
						<td>
							<input class="form-control " name = "goodPrice" id="goodPrice1" type="number" />
						</td>
					</tr>
					<tr>
						<td height="50px">
						...
						<td>
							<select id="goodType1" name="goodType">
